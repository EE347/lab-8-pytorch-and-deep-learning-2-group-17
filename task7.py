...
if __name__ == '__main__':
    ...
    with open('/home/pi/ee347/lab-8-pytorch-and-deep-learning-2-group-17/results_task7.csv', 'w', newline='') as csvfile:
        ...
        for loss_name, criterion in loss_functions.items():
            ...
            for epoch in range(1, 4):
                ...
                plt.title(f'Confusion Matrix - {loss_name} (Epoch {epoch})')
                plt.savefig(f'/home/pi/ee347/lab-8-pytorch-and-deep-learning-2-group-17/{loss_name}_confusion_matrix.png')
                plt.clf()
